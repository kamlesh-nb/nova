...
def __lldb_init_module(debugger, internal_dict):
    ...
    debugger.HandleCommand('type synthetic add -x "^Map<" --python-class nova_formatters.MapChildren')
    debugger.HandleCommand('type summary add -x "^Set<" -F nova_formatters.nova_set_summary')
    debugger.HandleCommand('type synthetic add -x "^Set<" --python-class nova_formatters.SetChildren')
