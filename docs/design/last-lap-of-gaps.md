...
| 2 | Crash surface / stability | **High (but small)** | 47/48 realistic programs clean; 1 known crash class (trait-vtable generic) | days (fix) + ongoing (harness) | [gap2](lastlap/gap2-crashes.md) |
