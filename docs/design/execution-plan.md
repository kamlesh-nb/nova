...
| **Z1** | **Docs: technical architecture + contributor onboarding** — **Nova architecture deep-dives DONE** (`docs/architecture/`: README overview + system map, 01-compiler, 02-codegen, 03-runtime, 04-stdlib/framework, 05-adding-a-feature onboarding). Remaining: BTreeDB + orchestrator architecture (separate repos) | P3 | ◑ | `docs/architecture/*` | (this session) |
