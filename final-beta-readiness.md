...
**Score: 39 defect IDs fixed, 4 investigated-not-a-bug, 0 open. CLUSTER B FULLY CLOSED
(B1-B6); every soundness-critical crash / UAF / corruption is fixed, AND the last open defect (A-nested)
is now fixed too. Session 2026-08-09 (9 fixes): D1/D2
...
generic return-owned-arg retain (9aadf25), container value-optional element leak (f6e7b86), and A-nested
nested value-optional (this commit). No known open soundness defects remain.
Recent:
